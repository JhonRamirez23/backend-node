import { ICreatable, IReadable, IUpdatable, IDeleatable, Query } from "./RepositoryTypes";
...
export interface IRolesService {
  ...
  findRoles(query?: Query): Promise<Roles[]>; // Usa el método get del repositorio genérico
